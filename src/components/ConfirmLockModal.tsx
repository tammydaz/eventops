    ...
    >
      ...
      >
        <div className="confirm-lock-header">
          <h2 id="confirm-lock-title">Confirm Lock</h2>
          <button
            type="button"
        ...
        <p className="confirm-lock-message">
          This will hard lock the event. Enter your initials to confirm.
        </p>
        <label htmlFor="confirm-lock-initials" className="confirm-lock-label">
          Initials
        </label>
        <input
          id="confirm-lock-initials"
          type="text"
